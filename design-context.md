...
- **Diagrams added 12:26 (2026-09-14):** `images/nucleus-mobile-journey-map.webp` (from "IHX Nucleus patient journey.png", 1920×1080: five stay moments × what the family wants to know, who they ask, why they get redirected, what Nucleus puts in hand) fills the 01 slot, and `images/nucleus-mobile-user-flow.webp` (from "IHX Nucleus IA.png", 1920×1080) fills the 05 slot; both captioned, originals in `_originals/nucleus-mobile/`. Known mismatches inside the artwork, flagged to Shabnam and left as supplied: the IA dashboard shows "Drafts" and "Discharge due today" (real UI: Active Claims, Discharges Due Today/Tomorrow, no Drafts) and says "Auto-suggest search" (MVP shipped structured search); both diagram titles use an em dash. The 01 and 05 `.hflow` step rows now partly repeat these diagrams.
